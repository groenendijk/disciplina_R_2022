...
## Veja que usando
Pessoas[1:10,] #Você seleciona as notas de exercicio da Bruna
#E que usando
Pessoas[-c(1:10),] #Você remove as linhas relativas da Bruna

#Apague as linhas do dataframe relativas as nota_exercicios do Giovani, pois ele não esta matriculado na disciplina e salve esse novo data frame como Pessoas2. 
#Use View(Pessoas) para ver quais sao as linhas do Giovani
